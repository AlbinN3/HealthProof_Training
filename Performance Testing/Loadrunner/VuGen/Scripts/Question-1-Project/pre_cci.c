# 1 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c"
...
# 1 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
# 2 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
# 3 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
# 4 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
HomePage()
{
	...
	lr_start_transaction("Entering the store");
	...
	lr_end_transaction("Entering the store",2);

	return 0;
}
# 5 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
LogIn()
{
	...
	lr_end_transaction("Logging in",2);

	return 0;
}
# 6 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
AddToCart()
{
	...
	lr_end_transaction("Adding to cart",2);

	return 0;
}
# 7 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
BuyItem()
{
	...
	lr_end_transaction("Buying an item",2);

	return 0;
}
# 8 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
Logout()
{
	...
	lr_end_transaction("Logging out",2);

	return 0;
}
# 9 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
...
# 10 "c:\\users\\administrator\\documents\\vugen\\scripts\\question-1-project\\\\combined_Question-1-Project.c" 2
